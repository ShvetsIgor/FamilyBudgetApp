/* All sticker-style icons + full taxonomy.
   Exposes `window.ICON_LIB` = { I, TAXONOMY, LABELS } */

const INK = '#3D2C1F';
const dark = (c) => `color-mix(in srgb, ${c} 70%, #3D2C1F)`;
...
const Hi = ({cx=10, cy=12, rx=2, ry=2.5, o=.5}) => <ellipse cx={cx} cy={cy} rx={rx} ry={ry} fill="white" opacity={o}/>;
...
I.brush = ({c, id}) => <svg viewBox="0 0 32 32"><Defs id={id} c={c}/>
  ...
  <path d="M13 19 L20 26 L21 27 L21 27" stroke={dark(c)} strokeWidth="1.5" fill="none"/>
  <Hi cx={6} cy={26}/>
</svg>;
 ...
 * ════════════════════════════════════════════ */
const TAXONOMY = [
  { id:'groceries', name:'Groceries',     ru:'Продукты',           color:'#E07A5F', icon:'cart', subs:[
    { id:'supermarket',     name:'Supermarket',         ru:'Супермаркет',         icon:'cart' },
    { id:'alcohol',         name:'Alcohol',             ru:'Алкоголь',            icon:'wine' },
    { id:'household_chem',  name:'Household Chemicals', ru:'Бытовая химия',       icon:'spray' },
    { id:'home_essentials', name:'Home Essentials',     ru:'Хоз. товары',         icon:'broom' },
    { id:'gro_other',       name:'Other',               ru:'Прочее',              icon:'box' },
  ]},
  { id:'dining', name:'Dining Out',       ru:'Кафе и рестораны',   color:'#D4A574', icon:'plate', subs:[
    { id:'restaurants', name:'Restaurants',        ru:'Рестораны',     icon:'plate' },
    ...
    { id:'snacks',      name:'Snacks & Ice Cream', ru:'Снэки и мороженое', icon:'icecream' },
    { id:'din_other',   name:'Other',              ru:'Прочее',        icon:'box' },
  ]},
  { id:'entertainment', name:'Entertainment', ru:'Развлечения',     color:'#A8B89C', icon:'cinema', subs:[
    { id:'movies',      name:'Movies',              ru:'Кино',          icon:'cinema' },
    { id:'parks',       name:'Parks & Attractions', ru:'Парки и аттракционы', icon:'ferris' },
    { id:'excursions',  name:'Excursions',          ru:'Экскурсии',     icon:'compass' },
  ...
  { id:'home', name:'Home & Bills',         ru:'Дом и счета',        color:'#81B29A', icon:'house', subs:[
    ...
    { id:'electricity',  name:'Electricity',        ru:'Электричество',  icon:'lightning' },
    { id:'water',        name:'Water',              ru:'Вода',           icon:'drop' },
    { id:'internet',     name:'Internet',           ru:'Интернет',       icon:'wifi' },
    { id:'mobile',       name:'Mobile',             ru:'Мобильная связь', icon:'phone' },
    ...
    { id:'home_purch',   name:'Home Purchases',     ru:'Покупки для дома', icon:'bag' },
  ...
  { id:'car', name:'Car',                  ru:'Машина',             color:'#8AA9D6', icon:'car', subs:[
    ...
    { id:'maintenance',  name:'Maintenance',        ru:'Обслуживание',   icon:'wrench' },
  ...
  { id:'transport', name:'Transport',      ru:'Транспорт',          color:'#F2CC8F', icon:'bus', subs:[
    { id:'public',       name:'Public Transport',   ru:'Общ. транспорт', icon:'bus' },
    { id:'taxi',         name:'Taxi',               ru:'Такси',          icon:'taxi' },
    { id:'train',        name:'Train',              ru:'Поезд',          icon:'train' },
    { id:'bus_pass',     name:'Bus Pass',           ru:'Проездной',      icon:'card' },
    { id:'tr_other',     name:'Other',              ru:'Прочее',         icon:'box' },
  ]},
  { id:'travel', name:'Travel',            ru:'Путешествия',        color:'#C97B84', icon:'plane', subs:[
    { id:'flights',      name:'Flights',            ru:'Перелёты',       icon:'plane' },
    { id:'hotels',       name:'Hotels',             ru:'Отели',          icon:'bed' },
    { id:'tr_abroad',    name:'Transport Abroad',   ru:'Транспорт',      icon:'compass' },
    { id:'food_abroad',  name:'Food Abroad',        ru:'Еда',            icon:'plate' },
    { id:'shop_abroad',  name:'Shopping Abroad',    ru:'Шоппинг',        icon:'bag' },
    { id:'tv_other',     name:'Other',              ru:'Прочее',         icon:'box' },
  ]},
  { id:'health', name:'Health',            ru:'Здоровье',           color:'#C97B84', icon:'heart', subs:[
    { id:'medicine',     name:'Medicine',           ru:'Лекарства',      icon:'pill' },
    { id:'doctors',      name:'Doctors',            ru:'Врачи',          icon:'stethoscope' },
    { id:'dentist',      name:'Dentist',            ru:'Стоматолог',     icon:'tooth' },
    { id:'fitness',      name:'Fitness',            ru:'Фитнес',         icon:'dumbbell' },
    { id:'h_insurance',  name:'Insurance',          ru:'Страховка',      icon:'shield' },
  ...
  { id:'shopping', name:'Shopping',        ru:'Покупки',            color:'#E9B384', icon:'bag', subs:[
    ...
    { id:'online',       name:'Online Shopping',    ru:'Онлайн',         icon:'online' },
  ...
  { id:'kids', name:'Kids',                ru:'Дети',               color:'#E07A5F', icon:'teddy', subs:[
    { id:'gifts',        name:'Gifts',              ru:'Подарки',        icon:'gift' },
    { id:'activities',   name:'Activities',         ru:'Кружки',         icon:'ball' },
    { id:'tutoring',     name:'Tutoring',           ru:'Репетиторы',     icon:'book' },
    { id:'school',       name:'School',             ru:'Школа',          icon:'backpack' },
    { id:'pocket',       name:'Pocket Money',       ru:'Карманные',      icon:'coin' },
    { id:'donations',    name:'Donations',          ru:'Пожертвования',  icon:'hands' },
  ...
  { id:'gifts', name:'Gifts',              ru:'Подарки',            color:'#C97B84', icon:'gift', subs:[
    { id:'birthdays',    name:'Birthdays',          ru:'Дни рождения',   icon:'cake' },
    { id:'holidays',     name:'Holidays',           ru:'Праздники',      icon:'palm' },
    { id:'charity',      name:'Charity',            ru:'Благотворит.',   icon:'hands' },
    { id:'g_donations',  name:'Donations',          ru:'Пожертвования',  icon:'heart' },
    { id:'g_other',      name:'Other',              ru:'Прочее',         icon:'box' },
  ]},
  { id:'digital', name:'Online & Digital', ru:'Онлайн и цифра',     color:'#8AA9D6', icon:'laptop', subs:[
    { id:'subscriptions',name:'Subscriptions',      ru:'Подписки',       icon:'tv' },
    { id:'games',        name:'Games',              ru:'Игры',           icon:'controller' },
    { id:'d_music',      name:'Music',              ru:'Музыка',         icon:'music' },
    { id:'streaming',    name:'Movies & Streaming', ru:'Стриминг',       icon:'cinema' },
    { id:'apps',         name:'Apps & Software',    ru:'Приложения',     icon:'phone' },
    { id:'cloud',        name:'Cloud Services',     ru:'Облако',         icon:'cloud' },
    { id:'d_other',      name:'Other',              ru:'Прочее',         icon:'box' },
  ]},
];
...
window.ICON_LIB = { I, TAXONOMY, INCOME };

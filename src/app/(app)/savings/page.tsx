  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4 px-4 pb-8 lg:px-4 lg:pt-2">
      <div className="rounded-2xl border border-border bg-card p-4">
        ...
        <input autoFocus value={name} onChange={(e) => setName(e.target.value)} placeholder={t('savings.namePlaceholder')}
      ...
      <div className="rounded-2xl border border-border bg-card p-4">
        ...
        <input type="number" min="0" step="0.01" placeholder="0.00" value={target} onChange={(e) => setTarget(e.target.value)}
      ...
      <div className="rounded-2xl border border-border bg-card p-4">
        ...
        <input type="date" value={deadline} onChange={(e) => setDeadline(e.target.value)}
          min={format(new Date(), 'yyyy-MM-dd')} className="w-full bg-transparent text-sm font-medium outline-none" />
      </div>

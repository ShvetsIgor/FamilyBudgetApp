...
export const TAXONOMY = [
  ...
  { id: 'dining',        name: 'Dining Out',        ru: 'Кафе и рестораны',   color: '#D4A574', icon: 'plate',      subs: [
    ...
    { id: 'snacks',       name: 'Snacks & Ice Cream', ru: 'Снэки',         icon: 'icecream' },
  ...
  { id: 'home',          name: 'Home & Bills',       ru: 'Дом и счета',        color: '#81B29A', icon: 'house',      subs: [
    ...
    { id: 'mobile',       name: 'Mobile',             ru: 'Мобильная',       icon: 'phone' },
    ...
    { id: 'home_purch',   name: 'Home Purchases',     ru: 'Для дома',        icon: 'bag' },
  ...
  { id: 'car',           name: 'Car',                ru: 'Машина',             color: '#8AA9D6', icon: 'car',        subs: [
    ...
    { id: 'maintenance',  name: 'Maintenance',        ru: 'ТО',        icon: 'wrench' },
  ...
  { id: 'kids',          name: 'Kids',               ru: 'Дети',               color: '#E07A5F', icon: 'teddy',      subs: [
    { id: 'gifts_kids',   name: 'Gifts',              ru: 'Подарки',    icon: 'gift' },
    ...
    { id: 'donations',    name: 'Donations',          ru: 'Донаты',     icon: 'hands' },

  ...
  return (
    <div className="p-3.5">
      <div className="flex items-center gap-2 mb-3">
        ...
        <p className="text-[13px] font-extrabold" style={{ color: C.fg }}>
          {t('chat.future.question')}
        </p>
      </div>
      <p className="text-[12px] font-semibold mb-3.5" style={{ color: C.sub }}>
        {note ? `${note} · ` : ''}{currency}{amount.toLocaleString()} · {dateLabel}
      </p>
      <div className="flex gap-2">
        <button
          onClick={onConfirm}
          className="flex-1 rounded-xl py-2.5 text-[13px] font-extrabold transition-opacity active:opacity-70"

    ...
    <div style={{ padding: '12px 14px 12px 12px' }}>
      <div className="flex items-start gap-2.5">
        ...
        <div className="flex-1 min-w-0">
          <p className="m-0 text-[14.5px] font-extrabold leading-snug" style={{ color: C.fg }}>
            {t('chat.morning.greeting')}
          </p>
          {yesterdayAmount > 0 && (
            <p className="m-0 mt-1 text-[13px] font-bold leading-snug" style={{ color: C.sub }}>
              {t('chat.morning.yesterdaySpent')}{' '}
              <span className="font-black tabular-nums" style={{ color: C.fg }}>
          ...
          {hasBudget && (
            <p className="m-0 mt-1 text-[13px] font-bold" style={{ color: C.sub }}>
              {t('chat.morning.freeToday')}{' '}
              <span className="font-black tabular-nums" style={{ color: C.primary }}>
